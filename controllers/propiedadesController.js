...
const guardar = async (req, res) => {
    ...
    // Crear un Registro
    const { titulo, descripcion, habitaciones, estacionamiento, banos, calle, lat, lng, precio: precioId, categoria: categoriaId } = req.body
...
const eliminar = async (req, res) => {
    ...
    if (!propiedad.imagen) {
        ...
        imagenAEliminar = await unlink(`public/uploads/${propiedad.imagen}`)
...
const enviarMensaje = async (req, res) => {
    ...
    // Comprobar que lam propiedad exista
    const propiedad = await Propiedad.findByPk(id, {
        include: [
            { model: Precio, as: "precio" },
            { model: Categoria, as: "categoria" }
